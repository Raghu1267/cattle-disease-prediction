...
@st.cache_resource
def load_my_model():
    return load_model("cattle_disease_model.keras")
...
with col2:
    if uploaded_file is not None:
        ...
        st.write("The model analyzes visual patterns such as lesions, texture, and color variations to classify diseases.")